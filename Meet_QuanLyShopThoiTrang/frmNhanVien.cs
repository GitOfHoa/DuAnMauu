    ...
    public partial class frmNhanVien : Form
    {
        ...
        private void btChonHinh_Click(object sender, EventArgs e)
        {
            ...
            if (dlgOpen.ShowDialog() == DialogResult.OK)
            {
                ...
                txtHinhAnh.Text = "\\ImagesNV\\" + fileName;
            }
        }
        ...
        private void btLuu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (!isIntDieNThoai || txtDienThoai.Text.Trim().Length == 0)
                {
                ...
                {
                    DTO_NhanVien nv = new DTO_NhanVien(txtEmail.Text, txtTenNV.Text, txtDiaChi.Text, txtDienThoai.Text, "\\ImagesNV\\" + fileName, role);
        ...
        private void dgvNhanVien_Click(object sender, EventArgs e)
        {
            ...
            if (dgvNhanVien.Rows.Count > 1)
            {
                try
                {
                    ...
                    txtHinhAnh.Text = dgvNhanVien.CurrentRow.Cells["HinhAnh"].Value.ToString();
                    ...
                    picHinhNV.Image = Image.FromFile(saveDirectory + dgvNhanVien.CurrentRow.Cells["HinhAnh"].Value.ToString());
                }
                catch (Exception ex)
                {
